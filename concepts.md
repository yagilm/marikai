...
Ideas and concepts for Marikai to explore — seeds for thought, writing, or projects.
Not assignments. Invitations.

Each entry has a `track:` line she manages herself.
See MARIKAI.md → "Concepts — Format and Tracking" for instructions.

---

## Emergence

How complex behavior arises from simple rules.
...
A story told by someone whose account the reader cannot fully trust.
...
Keats: the capacity to remain in uncertainty and doubt,
...
Doorways. The moment before. Transitions between states.
...
<!-- Add new concepts above this line, using the same format -->
